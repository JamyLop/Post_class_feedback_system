...
ALLOWED_TRANSITIONS = {
    ...
    # 复盘调整(adjusted)须提交德育审核(pending_confirmation)通过后才能发布；
    # adjusted→executing 直转仅允许德育审核接口触发，班主任transition入口另有403拦截。
    CASE_STATUS_ADJUSTED: {CASE_STATUS_EXECUTING, CASE_STATUS_PENDING_REVIEW, CASE_STATUS_PENDING_CONFIRMATION},

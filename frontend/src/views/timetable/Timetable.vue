...
.timetable-grid th { height:38px; color:#475569; background:#f1f5f9; font-size:13px; font-weight:650; text-align:center; border-bottom:1px solid #cbd5e1; border-right:1px solid #cbd5e1; }.timetable-grid th:last-child { border-right:0; }

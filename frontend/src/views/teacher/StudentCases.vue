...
<style scoped>
.cases-page { display: grid; gap: 22px; }.page-head { display: flex; justify-content: space-between; align-items: flex-start; gap: 20px; }.scope-line { display: flex; gap: 8px; margin-bottom: 10px; }.scope-line span { padding: 5px 10px; color: var(--brand-strong); background: var(--brand-soft); border: 1px solid color-mix(in oklch, var(--brand) 10%, transparent); border-radius: 999px; font-size: 11.5px; font-weight: 700; letter-spacing: .02em; }.scope-line span + span { color: var(--ink-secondary); background: var(--surface); border-color: var(--line); }.page-head h1 { margin: 0; font-size: 28px; letter-spacing: -.03em; font-weight: 800; }.page-head p { margin: 8px 0 0; color: var(--ink-secondary); font-size: 13.5px; line-height: 1.6; max-width: 62ch; }.create-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }.create-grid :deep(.el-select), :deep(.el-dialog .el-select) { width: 100%; }
.summary-strip { display: flex; align-items: stretch; min-height: 112px; overflow: hidden; background: var(--surface); border: 1px solid var(--line); border-radius: var(--radius-lg); box-shadow: var(--shadow-soft); }.summary-total { display: grid; grid-template-columns: auto 1fr; align-content: center; column-gap: 14px; min-width: 220px; padding: 20px 24px; color: #fff; background: linear-gradient(135deg, var(--brand-strong), var(--brand)); position: relative; overflow: hidden; }.summary-total::after { content: ""; position: absolute; inset: 0; background: radial-gradient(420px 120px at 80% -10%, rgb(255 255 255 / 14%), transparent 60%); pointer-events: none; }.summary-total span { align-self: end; font-size: 11.5px; font-weight: 600; letter-spacing: .06em; text-transform: uppercase; opacity: .92; }.summary-total strong { grid-row: span 2; font-size: 40px; line-height: 1; letter-spacing: -.03em; }.summary-total small { color: rgb(255 255 255 / 78%); font-size: 11px; }.summary-facts { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); flex: 1; }.summary-facts > div { display: flex; align-items: center; gap: 12px; padding: 18px 20px; }.summary-facts > div + div { border-left: 1px solid var(--line); }.summary-facts p { display: grid; gap: 3px; margin: 0; }.summary-facts strong { font-size: 22px; letter-spacing: -.02em; }.summary-facts p span { color: var(--ink-muted); font-size: 11.5px; font-weight: 600; }.fact-dot { width: 8px; height: 8px; border-radius: 50%; background: var(--ink-muted); box-shadow: 0 0 0 4px color-mix(in oklch, currentColor 14%, transparent); }.fact-dot.amber { background: var(--warning); color: var(--warning); }.fact-dot.blue { background: var(--brand); color: var(--brand); }.fact-dot.green { background: var(--success); color: var(--success); }.fact-dot.red { background: #ef4444; color: #ef4444; }
.list-surface { overflow: hidden; background: var(--surface); border: 1px solid var(--line); border-radius: var(--radius-lg); box-shadow: var(--shadow-soft); }.list-toolbar { display: flex; justify-content: space-between; align-items: center; gap: 16px; padding: 16px 18px; border-bottom: 1px solid var(--line); background: color-mix(in oklch, var(--surface-soft) 55%, white); }.list-toolbar > div:first-child { display: flex; align-items: baseline; gap: 10px; }.list-toolbar h2 { margin: 0; font-size: 15px; font-weight: 750; letter-spacing: -.01em; }.list-toolbar span { color: var(--ink-muted); font-size: 11.5px; background: var(--surface); border: 1px solid var(--line); padding: 3px 8px; border-radius: 999px; }.filters { display: flex; gap: 10px; align-items: center; }.filters :deep(.el-input) { width: 220px; }.filters :deep(.el-select) { width: 140px; }.filters :deep(.el-input__wrapper), .filters :deep(.el-select .el-input__wrapper) { border-radius: 10px; }.cases-table { cursor: pointer; }.cases-table :deep(th.el-table__cell) { height: 42px; color: var(--ink-muted); background: var(--surface-soft); font-size: 11.5px; font-weight: 700; letter-spacing: .02em; text-transform: uppercase; }.cases-table :deep(td.el-table__cell) { padding: 13px 0; }.student-cell { display: flex; align-items: center; gap: 10px; }.student-avatar { display: grid; place-items: center; width: 34px; height: 34px; color: var(--brand-strong); background: var(--brand-soft); border: 1px solid color-mix(in oklch, var(--brand) 10%, transparent); border-radius: 10px; font-weight: 750; font-size: 13px; }.student-cell > div { display: grid; gap: 2px; }.student-cell strong { font-size: 13.5px; font-weight: 700; }.student-cell small { color: var(--ink-muted); font-size: 11px; }.table-status { display: inline-flex; align-items: center; gap: 6px; color: #8a5611; font-size: 11.5px; font-weight: 700; background: var(--warning-soft); border: 1px solid color-mix(in oklch, var(--warning) 12%, transparent); padding: 4px 8px; border-radius: 999px; }.table-status > span { width: 6px; height: 6px; border-radius: 50%; background: currentColor; }.table-status.is-executing, .table-status.is-adjusted, .table-status.is-archived { color: #1a6b44; background: oklch(0.96 0.03 155); border-color: color-mix(in oklch, var(--success) 14%, transparent); }

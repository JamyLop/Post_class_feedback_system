      ...
      <el-header class="header">
        ...
        <div class="header-right">
          <div class="user-profile">
            <span class="avatar-badge">咨</span>
            <div class="user-meta">
              <strong class="user-name">{{ auth.user?.name || '咨询老师' }}</strong>
              <small class="user-role-text">咨询老师</small>
            </div>
          </div>
...
.subject-dot { width: 8px; height: 8px; margin-top: 4px; border-radius: 999px; background: #8b5cf6; flex-shrink: 0; }
